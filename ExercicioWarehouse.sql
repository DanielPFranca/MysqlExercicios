...
alter table orderdetails add constraint orderLineNumber foreign key (orderLineNumber) references orders(orderNumber_id);
...
alter table offices modify postalCode numeric(10) not null;
